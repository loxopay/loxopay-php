...
$invoice = new \Loxopay\Models\Request\Invoice();
...
$invoice->setDescription('Thanks for using Loxopay to pay your order');

// administrative information, which provider to use (psp)
// psp #1 = Loxopay' test mode, see http://developers.loxopay.ch/docs/miscellaneous
//$invoice->setPsp([]);
...
// http://developers.loxopay.ch/docs/miscellaneous
...
try {
    $response = $loxopay->create($invoice);
    var_dump($response);
