 ...
 */
class Invoice extends \Loxopay\Models\Base
{
     ...
     * can be found here: http://developers.loxopay.ch/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the Loxopay site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.loxopay.ch/docs/miscellaneous
     *
    ...
    {
        return new \Loxopay\Models\Response\Invoice();
    }
}
